...
export const PaymentReceipt = React.forwardRef<HTMLDivElement, PaymentReceiptProps>(({ buyer, invoice, paymentHistory }, ref) => {
  return (
    <div ref={ref}>
                    ...
                    <TableBody>
                        {paymentHistory.length > 0 ? paymentHistory.map(payment => (
                            <TableRow key={payment.id}>
                                <TableCell className="text-black">{payment.date}</TableCell>
